  ...
  List<Widget> _buildPageList(BuildContext context) {
    return [
      ...
      buildPage(
        ...
        'assets/ob/ob1.jpg',  // Image representing profile
      ...
      buildPage(
        ...
        'assets/ob/ob2.jpg',  // Image representing attendance
      ...
      buildPage(
        ...
        'assets/ob/ob3.jpg',  // Image representing timetable
      ...
      buildPage(
        ...
        'assets/ob/ob4.jpg',  // Image for syllabus or documents
      ...
      buildPage(
        ...
        'assets/ob/ob5.jpg',  // Image for staff login placeholder
